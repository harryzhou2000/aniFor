...
export function mountSandboxShell(options: ShellOptions): SandboxShell {
  ...
  const onClick = (event: Event): void => {
    ...
    if (button.dataset.action === "clear") options.onAppIntent({ type: "clear" });
  };
