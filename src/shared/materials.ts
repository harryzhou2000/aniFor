export const enum Material {
  ...
  VRSG = 215,
  VRSS = 216,
  // Ordinary menu-visible TPT brush added after the stable projection range.
  // Unlike IDs 171-216, this crosses the generic native particle ABI.
  BCOL = 217,
}
...
export const ALL_MATERIALS: readonly MaterialInfo[] = [
  ...
  { id: Material.SEED, name: 'SEED', description: 'Seeds. Put on sand and add water to grow a tree.', color: '#88e788', icon: '·', category: 'life', phase: 'powder', selectable: true },
  ...
  { id: Material.YEST, name: 'YEST', description: 'Yeast, grows when warm (~37C).', color: '#eee0c0', icon: '·', category: 'life', phase: 'powder', selectable: true },
  ...
  { id: Material.BVBR, name: 'BVBR', description: 'Broken vibranium.', color: '#005000', icon: '◆', category: 'radioactive', phase: 'powder', selectable: true, hazard: 'caution' },
  ...
  { id: Material.PLUT, name: 'PLUT', description: 'Plutonium. Heavy, fissile particles. Generates neutrons under pressure.', color: '#407020', icon: '◆', category: 'radioactive', phase: 'powder', selectable: true, hazard: 'danger' },
  { id: Material.POLO, name: 'POLO', description: 'Polonium, highly radioactive. Decays into NEUT and heats up.', color: '#506030', icon: '◆', category: 'radioactive', phase: 'powder', selectable: true, hazard: 'danger' },
  ...
  { id: Material.SING, name: 'SING', description: 'Singularity. Creates huge amounts of negative pressure and destroys everything.', color: '#242424', icon: '◆', category: 'radioactive', phase: 'powder', selectable: true, hazard: 'danger' },
  { id: Material.URAN, name: 'URAN', description: 'Uranium. Heavy particles. Generates heat under pressure.', color: '#707020', icon: '◆', category: 'radioactive', phase: 'powder', selectable: true, hazard: 'caution' },
  ...
  { id: Material.ACEL, name: 'ACEL', description: 'Accelerator, speeds up nearby elements.', color: '#0099cc', icon: '➜', category: 'force', phase: 'solid', selectable: true },
  { id: Material.DCEL, name: 'DCEL', description: 'Decelerator, slows down nearby elements.', color: '#99cc00', icon: '➜', category: 'force', phase: 'solid', selectable: true },
  { id: Material.DMG, name: 'DMG', description: 'Generates damaging pressure and breaks any elements it hits.', color: '#88ff88', icon: '➜', category: 'force', phase: 'powder', selectable: true, hazard: 'danger' },
  { id: Material.FRAY, name: 'FRAY', description: 'Force Emitter. Pushes or pulls objects based on its temperature. Use like ARAY.', color: '#00bbff', icon: '➜', category: 'force', phase: 'solid', selectable: true },
  { id: Material.FRME, name: 'FRME', description: 'Frame, can be used with pistons to push many particles.', color: '#999988', icon: '➜', category: 'force', phase: 'solid', selectable: true },
  { id: Material.GBMB, name: 'GBMB', description: 'Gravity bomb. Sticks to the first object it touches then produces a strong gravity push.', color: '#1144bb', icon: '➜', category: 'force', phase: 'powder', selectable: true, hazard: 'danger', available: false, limitations: ['newtonian-gravity-unavailable'] },
  { id: Material.PIPE, name: 'PIPE', description: 'PIPE, moves particles around. Once the BRCK generates, erase some for the exit. Then the PIPE generates and is usable.', color: '#444444', icon: '➜', category: 'force', phase: 'solid', selectable: true },
  { id: Material.PSTN, name: 'PSTN', description: 'Piston, pushes particles. PSCN extends, NSCN retracts', color: '#aa9999', icon: '➜', category: 'force', phase: 'solid', selectable: true },
  { id: Material.RPEL, name: 'RPEL', description: 'Repels or attracts particles based on its temperature.', color: '#99cc00', icon: '➜', category: 'force', phase: 'solid', selectable: true },
  { id: Material.BCLN, name: 'BCLN', description: 'Breakable Clone.', color: '#ffd040', icon: '◇', category: 'special', phase: 'solid', selectable: true },
  { id: Material.BHOL, name: 'VACU', description: 'Vacuum, sucks in other particles and heats up.', color: '#303030', icon: '◇', category: 'special', phase: 'solid', selectable: true, hazard: 'danger' },
  { id: Material.CLNE, name: 'CLNE', description: 'Clone. Duplicates any particles it touches.', color: '#ffd010', icon: '◇', category: 'special', phase: 'solid', selectable: true },
  { id: Material.CONV, name: 'CONV', description: 'Converter. Converts everything into whatever it first touches.', color: '#0aab0a', icon: '◇', category: 'special', phase: 'solid', selectable: true },
  { id: Material.NBHL, name: 'BHOL', description: 'Black hole, sucks in particles using gravity. (Requires Newtonian gravity)', color: '#202020', icon: '◇', category: 'special', phase: 'solid', selectable: true, hazard: 'danger', available: false, limitations: ['newtonian-gravity-unavailable'] },
  { id: Material.NWHL, name: 'WHOL', description: 'White hole, pushes away other particles with gravity. (Requires Newtonian gravity)', color: '#ffffff', icon: '◇', category: 'special', phase: 'solid', selectable: true, hazard: 'danger', available: false, limitations: ['newtonian-gravity-unavailable'] },
  { id: Material.PRTI, name: 'PRTI', description: 'Portal IN. Particles go in here. Also has temperature dependent channels. (same as WIFI)', color: '#eb5917', icon: '◇', category: 'special', phase: 'solid', selectable: true },
  { id: Material.PRTO, name: 'PRTO', description: 'Portal OUT. Particles come out here. Also has temperature dependent channels. (same as WIFI)', color: '#0020eb', icon: '◇', category: 'special', phase: 'solid', selectable: true },
  { id: Material.TRON, name: 'TRON', description: 'Smart particles, Travels in straight lines and avoids obstacles. Grows with time.', color: '#a9ff00', icon: '◇', category: 'special', phase: 'solid', selectable: true },
  { id: Material.VOID, name: 'VOID', description: 'Hole, will drain away any particles.', color: '#790b0b', icon: '◇', category: 'special', phase: 'solid', selectable: true, hazard: 'danger' },
  { id: Material.WHOL, name: 'VENT', description: 'Air vent, creates pressure and pushes other particles away.', color: '#efefef', icon: '◇', category: 'special', phase: 'solid', selectable: true, limitations: ['air-velocity-limited'] },
  ...
  ...NATIVE_PROJECTIONS,
  {
    id: Material.BCOL,
    name: 'BCOL',
    description: 'Broken Coal. Heavy particles that burn slowly.',
    color: '#333333',
    icon: '·',
    category: 'powders',
    phase: 'powder',
