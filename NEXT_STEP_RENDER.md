...
If you want, I can go deeper on any single phase — e.g. the exact render-target layout for the WebGL2 pipeline, or the curvature-flow smoothing math adapted to your cell data.
