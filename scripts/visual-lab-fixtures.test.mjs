...
describe('Visual Lab fixture adapters', () => {
  ...
  it('adds source-stage Powder and material-lighting domains only to generic capture-facing catalogs', () => {
    ...
    expect(resolveVisualCaptureFixture('gas-material-lighting-atlas', 'material-lighting', 0))
      .toMatchObject({
        scene: 'showcase',
        captureDriver: 'material-lighting-profile',
        preparation: { reportLabel: 'prepareGasMaterialLightingAtlasFixture' },
      });
    expect(resolveVisualCaptureFixture('solid-material-lighting-atlas', 'material-lighting', 0))
      .toMatchObject({
        scene: 'showcase',
        captureDriver: 'material-lighting-profile',
    ...
    expect(resolveVisualCaptureFixture('source-target-material-lighting-atlas', 'material-lighting', 0))
      .toMatchObject({
        scene: 'showcase',
        captureDriver: 'material-lighting-profile',
        preparation: { reportLabel: 'prepareSourceTargetGraphicsAuditFixture' },
      });
    expect(resolveVisualCaptureFixture('thermal-source-material-lighting-atlas', 'material-lighting', 0))
      .toMatchObject({
        scene: 'showcase',
        captureDriver: 'material-lighting-profile',
        preparation: { reportLabel: 'prepareCeramicTemperatureVfxFixture' },
      });
    expect(resolveVisualCaptureFixture('opposed-source-material-lighting-atlas', 'material-lighting', 0))
      .toMatchObject({
        scene: 'showcase',
        captureDriver: 'material-lighting-profile',
        preparation: { reportLabel: 'preparePowderLightVfxFixture' },
      });
    expect(resolveVisualCaptureFixture('wax-material-lighting-atlas', 'material-lighting', 0))
      .toMatchObject({
        scene: 'showcase',
        captureDriver: 'material-lighting-profile',
  ...
  it('resolves each production request to one frozen fixture-owned driver tuple', () => {
    for (const [request, driver] of [
      ...
      [{ domain: 'material-lighting', target: 0, fixture: 'source-target-material-lighting-atlas' },
        'material-lighting-profile'],
      [{ domain: 'material-lighting', target: 0, fixture: 'force-activity-material-lighting-atlas' },
        'material-lighting-profile'],
      [{ domain: 'material-lighting', target: 0, fixture: 'thermal-source-material-lighting-atlas' },
        'material-lighting-profile'],
